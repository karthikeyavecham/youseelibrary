...
<fieldset><legend>Personal & Contact Info</legend>
 <div >
...
<fieldset style="margin-left:30px;"><legend>Confirm That You are not a Robot</legend><table>
		<tr> <td>&nbsp</td><td >
...
<div style="margin-left: 100px;"><input id="register"
	style="visibility: visible" name="submit" type="submit"
	value="Register" />
	<input id="register"
	style="visibility: visible" name="cancel" type="button" value="Cancel" 
	onclick="our_library_cities.php" > 
	</div>
