...
<?php
//when a search button is clicked after choosing a location ($location) OR a city is clicked on the map then list all the books in that city
} else if(  isset($location)  || isset($chosenlocationid)  )  {
?>
